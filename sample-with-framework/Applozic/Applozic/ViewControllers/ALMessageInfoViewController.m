...
-(UIView *)customHeaderView:(NSInteger)section withTitle:(NSString *)title andName:(NSString *)name
{
    ...
    [self.headerTitle setFont:[UIFont fontWithName:[ALApplozicSettings getCustomMessageFont] size:15]];
...
-(UIView *)populateCellForMessage:(CGSize)cellSize
{
    ...
    [textView setFont:[UIFont fontWithName:[ALApplozicSettings getCustomMessageFont] size:14]];
    ...
    if([self.almessage.fileMeta.contentType hasPrefix:@"audio"])
    {
        ...
        [textView setFont:[UIFont fontWithName:[ALApplozicSettings getCustomMessageFont] size:12]];
